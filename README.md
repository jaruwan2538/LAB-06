...
2). โปรแกรมสำหรับรับตัวอักษรจากคีย์บอร์ด 
 ...
 ![](https://github.com/Desktop-Programming-Lab-2559/LAB-06/blob/master/imgs/pic1.png)
  ...
  ![](https://github.com/jaruwan2538/LAB-06/blob/master/imgs/Capture6.1.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
![](https://github.com/jaruwan2538/LAB-06/blob/master/imgs/Capture6.2.PNG?raw=true)
...
![](https://github.com/jaruwan2538/LAB-06/blob/master/imgs/Capture6.3.PNG?raw=true)

###คำถาม 6.3 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร
```
โปรแกรม error ทำให้โปรแกรม hang จึงต้องมีการป้องกันโดยใช้ประโยค try {}
```
...
![](https://github.com/jaruwan2538/LAB-06/blob/master/imgs/Capture6.4.PNG?raw=true)

###คำถาม 6.4 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น เหมือนหรือต่างจากโปรแกรมก่อนหน้านี้อย่างไร
```
ไม่ต่างจากการรันผลโปรแกรมก่อนหน้านี้
```
...
![](https://github.com/jaruwan2538/LAB-06/blob/master/imgs/Capture6.5.PNG?raw=true)
